...
export function DemoShowcase() {
  return (
    <section className="relative isolate overflow-hidden">
      ...
      <div className="pointer-events-none absolute left-1/2 top-1/3 -z-10 h-96 w-[42rem] -translate-x-1/2 rounded-full bg-accent/8 blur-[130px]" />
        ...
        <div className="grid gap-10 lg:grid-cols-[minmax(0,0.85fr)_minmax(0,1.15fr)] lg:items-center">
          <Reveal className="min-w-0">
            ...
            <a
              ...
              className="group mt-9 inline-flex items-center gap-2 rounded-xl bg-foreground px-5 py-3 text-sm font-medium text-background transition-all duration-300 hover:-translate-y-0.5 hover:accent-ring"
            >
              Explorar demo
